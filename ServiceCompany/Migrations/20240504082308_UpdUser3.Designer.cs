...
namespace ServiceCompany.Migrations
{
    ...
    [Migration("20240504082308_UpdUser3")]
    partial class UpdUser3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ManagementCompany.DbStuff.Models.User", b =>
                {
                    ...
                    b.HasOne("ManagementCompany.DbStuff.Models.UserProfile", "Profile")
                        .WithOne("User")
                        .HasForeignKey("ManagementCompany.DbStuff.Models.User", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
