...
using ServiceCompany.DbStuff.Postgres.Entities;
using System.Reflection.Emit;

namespace ServiceCompany.DbStuff.Postgres
{
    public class ServiceCompanyPostgresDbContext : DbContext
    {
        ...
        public ServiceCompanyPostgresDbContext(DbContextOptions<ServiceCompanyPostgresDbContext> options) : base(options)
        {
